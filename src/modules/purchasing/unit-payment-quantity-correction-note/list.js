...
export class List {
    ...
    context = ["detail", "cetak", "cetak nota retur"]
    ...
    columns = [
      ...
      { field: "unitPaymentOrder.category.name", title: "Kategori" },
    ...
    loader = (info) => {
        ...
        var arg = {
            ...
            order: order,
            select: [
            "no", "date", "unitPaymentOrder.dueDate", "unitPaymentOrder.no", "unitPaymentOrder.division.name", "unitPaymentOrder.category.name", "unitPaymentOrder.supplier.name"
        ]
        }

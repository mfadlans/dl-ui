...
import AccountUnitItemReact from './role-permission-item-react.jsx';
...
export default class RolePermissionItemCollectionReact extends React.Component {
    ...
    render() {
        var items = (this.state.value || []).map(function (item, index) {
            ...
            return (
                <AccountUnitItemReact key={"__item" + index} value={item} error={error} options={this.state.options} onRemove={this.handleItemRemove}></AccountUnitItemReact>
            );
        }.bind(this))
